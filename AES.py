...
def expandir_chave(chave):
    ...
    w = [0]*(4*(num_rodadas+1)) #Lista de palavras

    #Divisão da chaves em 4 palavras de 4 bytes na lista
    for i in range(num_palavras):
        w[i] = [chave[4*i], chave[4*i+1], chave[4*i+2], chave[4*i+3]]
...
def criptografar(texto, chave):
    ...
    chaves_rodadas = expandir_chave(chave) #Definição de chaves de rodadas
